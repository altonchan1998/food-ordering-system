...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // create a single instance of this test class
@SpringBootTest(classes = OrderTestConfiguration.class) // Specify this class to create mock beans
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("1ad31d4a-b0dc-4e4f-9fcc-a10122f7e5f2");
    private final UUID RESTAURANT_ID = UUID.fromString("92c31d8a-5699-48d3-9f11-cf617d52895c");
    private final UUID PRODUCT_ID_1 = UUID.fromString("996e7e46-d1f5-4957-92fb-60365f1e49ad");
    private final UUID PRODUCT_ID_2 = UUID.fromString("7dc13cfa-3c0c-45e4-bc23-4a19365712fb");
    private final UUID ORDER_ID = UUID.fromString("83994a5d-1253-40b3-a864-122d491d9d51");
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        Assertions.assertEquals("Order item price: 60.00 is not valid for product " + PRODUCT_ID_1, orderDomainException.getMessage());
    }
